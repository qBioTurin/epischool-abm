...
To reproduce the results of the short paper run:
```
./reproduce_abstract.sh NumberOfThreads
```

To reproduce the results of the extended version of the short paper run:
```
./reproduce_extended.sh NumberOfThreads
```
